...
public class Extractor {
    ...
    public void getPageLinks(String URL) {
        if (!links.contains(URL)) {
            try {
                ...
                Elements otherLinks = document.select("dd");
    ...
    public void getArticles() {
        links.forEach(x -> {
            ...
            try {
                ...
                Elements articleLinks = document.select("dd");
    ...
    public static void main(String[] args) {
        ...
        bwc.getPageLinks("https://www.myhome.go.kr/hws/portal/sch/selectRsdtRcritNtcDetailView.do?pblancId=2221");
        bwc.getArticles();
